...
Generation: Azure AI Foundry image generation via `/opt/fleet/lib/gen-image.sh`, deployment `factory-image`, 2026-08-28. Generated imagery is original for this product. Source PNG and exact prompt sidecar live in `assets/src/`; optimized WebP/AVIF derivatives ship in the frontend. Provenance stays in this internal design record because the public footer makes only observable product claims.
